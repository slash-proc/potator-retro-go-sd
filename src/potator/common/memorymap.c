...
{
    /* Hot WRAM / regs: DTCM bump (was itc_malloc). ITCM is reserved for code. */
    lowerRam = (uint8*)dtc_malloc(0x2000);
    upperRam = (uint8*)dtc_malloc(0x2000);
    regs     = (uint8*)dtc_malloc(0x2000);
}
